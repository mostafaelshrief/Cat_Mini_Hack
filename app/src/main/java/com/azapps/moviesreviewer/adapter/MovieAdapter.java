...
public class MovieAdapter extends ListAdapter<Results, MovieViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MovieViewHolder holder, int position) {
        ...
        holder.titleTV.setText(currentMovie.getOriginal_title());
        holder.ratingBar.setImageResource(R.drawable.ic_baseline_star_rate_24);
    ...
    public void OnMovieClickListener(OnMovieClickListener listener) {
